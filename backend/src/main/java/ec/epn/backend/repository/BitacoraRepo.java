...
public class BitacoraRepo {
  ...
  public java.util.List<java.util.Map<String, Object>> listarPendientesPorProyectoParaDirector(String proyectoId,
  ...
  /**
   * ✅ NUEVO: Obtener historial completo (todas las bitácoras) de un contrato
   * Incluye: APROBADAS, RECHAZADAS, ENVIADAS, BORRADORES
   */
  public java.util.List<java.util.Map<String, Object>> listarTodasPorContrato(String contratoId) {
    return jdbc.query("""
  ...
  /**
   * ✅ NUEVO: Listar todas las bitácoras de un proyecto (para director)
   * Incluye todas las bitácoras de todos los ayudantes del proyecto
   */
  public java.util.List<java.util.Map<String, Object>> listarTodasPorProyectoParaDirector(String proyectoId,
      String correoDirector) {
    return jdbc.query("""
          SELECT
            b.id AS bitacora_id,
